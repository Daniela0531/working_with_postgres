...
#define TOAST_BROTLI_COMPRESSION		'b'
...
/* brotli compression/decompression routines */
extern struct varlena *brotli_compress_datum(const struct varlena *value);
extern struct varlena *brotli_decompress_datum(const struct varlena *value);
extern struct varlena *brotli_decompress_datum_slice(const struct varlena *value,
                                                  int32 slicelength);
