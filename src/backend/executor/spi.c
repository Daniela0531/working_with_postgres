...
_SPI_execute_plan(SPIPlanPtr plan, const SPIExecuteOptions *options,
				  ...
				  bool fire_triggers)
{
	// elog(WARNING, "my log in _SPI_execute_plan");
	int			my_res = 0;
...
_SPI_pquery(QueryDesc *queryDesc, bool fire_triggers, uint64 tcount)
{
	...
	elog(LOG, "my log in _SPI_pquery next ExecutorStart");
					  ...
					  DestReceiver *dest)
{
	...
	/* Run the cursor */
	// elog(WARNING, "my log in _SPI_cursor_operation next PortalRunFetch");
