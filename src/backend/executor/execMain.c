...
ExecutorStart(QueryDesc *queryDesc, int eflags)
{
	...
	if (ExecutorStart_hook)
		...
		elog(LOG, "my log in ExecutorStart next standard_ExecutorStart");
...
standard_ExecutorStart(QueryDesc *queryDesc, int eflags)
{
	 ...
	 */
	elog(LOG, "my log standard_ExucutorStart next InitPlan");
...
InitPlan(QueryDesc *queryDesc, int eflags)
{
	...
	foreach(l, plannedstmt->subplans)
	{
		...
		elog(LOG, "my log in InitPlan next ExecInitNode");
	 ...
	 * processing tuples.
	 */
	elog(LOG, "my log in InitPlan next ExecInitNode planstate");
...
EvalPlanQualStart(EPQState *epqstate, Plan *planTree)
{
	...
	foreach(l, parentestate->es_plannedstmt->subplans)
	{
		...
		elog(LOG, "my log in EvalPlanQualStart next ExecInitNode subplanstate");
	 ...
	 */
	elog(LOG, "my log in EvalPlanQualStart next ExecInitNode epqstate->recheckplanstate");
