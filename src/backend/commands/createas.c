...
create_ctas_internal(List *attrList, IntoClause *into)
{
	 ...
	 */
	// elog(WARNING, "my log in create_ctas_internal next DefineRelation");
				  ...
				  QueryCompletion *qc)
{
	...
	else
	{
		...
		elog(LOG, "my log in ExecCreateTableAs next ExecutorStart");
...
intorel_receive(TupleTableSlot *slot, DestReceiver *self)
{
	...
	if (!myState->into->skipData)
	{
		 ...
		 */
		elog(LOG, "my log in intorel_receive next table_tuple_insert");
