...
heap_toast_insert_or_update(Relation rel, HeapTuple newtup, HeapTuple oldtup,
							int options)
{
	// elog(WARNING, "my log heap_toast_insert_or_update next some toast_tuple_try_compression");
	...
	// my log : need to set correct TupleDescAttr(ttc->ttc_rel->rd_att, i)->attcompression;
