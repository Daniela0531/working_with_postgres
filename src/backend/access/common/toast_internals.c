...
{
	// elog(WARNING, "my log into toast_compress_datum\n");
				 ...
				 struct varlena *oldexternal, int options)
{
	...
	while (data_todo > 0)
	{
		...
		elog(LOG, "my log in toast_save_datum next heap_insert");
