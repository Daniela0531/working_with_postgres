...
exec_simple_query(const char *query_string)
{
	...
	printf("parsetree_list, len = %d\n", parsetree_list->length);
	fflush(stdout);
	...
	foreach(parsetree_item, parsetree_list)
	{
		 ...
		 */
		// elog(WARNING, "my log in exec_simple_query next PortalRun");
...
exec_execute_message(const char *portal_name, long max_rows)
{
	...
	// elog(WARNING, "my log in exec_execute_message next PortalRun");
					   ...
					   const char *username)
{
	 ...
	 * can do the rest.
	 */
	// elog(WARNING, "my log in PostgresSinglUserMain next PostgresMain");
			...
			case PqMsg_Query:
				{
					...
					if (am_walsender)
					{
						if (!exec_replication_command(query_string)) {
							// elog(WARNING, "my log in PostgresMain next exec_simple_query");
			...
			case PqMsg_Execute:
				{
					...
					// elog(WARNING, "my log in PostgresMain next exec_execute_message");
