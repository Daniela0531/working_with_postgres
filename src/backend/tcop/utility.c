...
ProcessUtility(PlannedStmt *pstmt,
			   ...
			   QueryCompletion *qc)
{
	// elog(WARNING, "my log in ProcessUtility");
	Assert(IsA(pstmt, PlannedStmt));
...
standard_ProcessUtility(PlannedStmt *pstmt,
						...
						QueryCompletion *qc)
{
	// elog(WARNING, "my log in standard_ProcessUtility next some ProcessUtilitySlow");
...
ProcessUtilitySlow(ParseState *pstate,
				   ...
				   QueryCompletion *qc)
{
	// elog(WARNING, "my log in ProcessUtilitySlow");
	...
	PG_TRY();
	{
		...
		switch (nodeTag(parsetree))
		{
			...
			case T_CreateForeignTableStmt:
				{
					...
					while (stmts != NIL)
					{
						...
						if (IsA(stmt, CreateStmt))
						{
							...
							// elog(WARNING, "my log in ProcessUtilitySlow next DefineRelation");
			...
			case T_AlterTableStmt:
				{
					...
					if (OidIsValid(relid))
					{
						...
						/* ... and do it */
						// elog(WARNING, "my log in ProcessUtilitySlow next AlterTable");
			...
			case T_CreateSeqStmt:
				// elog(WARNING, "my log in ProcessUtilitySlow next DefineSequence");
...
{
	// elog(WARNING, "my log in ProcessUtilityForAlterTable");
	PlannedStmt *wrapper;
