...
{
	// elog(WARNING, "my log in PostmasterChildName next child_process_kinds where is BackendMain");
						...
						ClientSocket *client_sock)
{
	...
	if (pid == 0)				/* child */
	{
		 ...
		 */
		// elog(WARNING, "my log in postmaster_child_launch next child_process_kinds");
